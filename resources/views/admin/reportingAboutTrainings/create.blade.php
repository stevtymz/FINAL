...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} A reportingAboutTraining
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.reporting-about-trainings.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="training">Training</label>
                <input class="form-control {{ $errors->has('training') ? 'is-invalid' : '' }}" type="text" name="training" id="training" value="{{ old('training', '') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('employee_feedback') ? 'is-invalid' : '' }}" name="employee_feedback" id="employee_feedback" required>{{ old('employee_feedback') }}</textarea>
