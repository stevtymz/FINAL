    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.salaries.update", [$salary->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('job_title') ? 'is-invalid' : '' }}" type="text" name="job_title" id="job_title" value="{{ old('job_title', $salary->job_title) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('salary_scale') ? 'is-invalid' : '' }}" type="text" name="salary_scale" id="salary_scale" value="{{ old('salary_scale', $salary->salary_scale) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ammount') ? 'is-invalid' : '' }}" type="number" name="ammount" id="ammount" value="{{ old('ammount', $salary->ammount) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('year') ? 'is-invalid' : '' }}" type="text" name="year" id="year" value="{{ old('year', $salary->year) }}" required>
                @if($errors->has('year'))
